...
<section id="menu">
    <h1 class="title-header">Menu</h1>
    <h2>Nos menus sont <span class="body-highlight">communs</span> à tous nos restaurants</h2>
    <img src="images/menu.png" alt="menu Yummy Nouilles">
</section>
